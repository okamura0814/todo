                ...
                <div class="card-body">
                    <form method="POST" id="update_form" action="{{ route('todo.update',$todo->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="datepicker" type="text" class="form-control @error('due_date') is-invalid @enderror" name="due_date" value="{{ old('due_date',$todo->due_date) }}" autocomplete="due_date">
